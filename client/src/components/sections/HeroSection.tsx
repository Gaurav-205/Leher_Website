...
const HeroSection = () => {
  return (
    <section 
      id="main-content"
      className="relative min-h-[100vh] sm:h-[95vh] md:h-[90vh] lg:h-[85vh] flex items-center justify-center px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12 overflow-hidden bg-white dark:bg-[#0F0F23]"
      role="banner"
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto text-center w-full px-2 sm:px-4 md:px-6 lg:px-8 xl:px-12">
        ...
        <div className="inline-flex items-center px-3 sm:px-4 md:px-5 py-2 md:py-2.5 rounded-full bg-gradient-to-r from-[#A8CFF1]/20 to-[#B9A6DC]/20 dark:from-[#1A1A2E]/50 dark:to-[#16213E]/50 border border-[#A8CFF1]/30 dark:border-[#A8CFF1]/20 text-[#2A3E66] dark:text-[#E8E8E8] text-xs sm:text-sm md:text-base font-medium mb-4 sm:mb-5 md:mb-6 font-montserrat">
        ...
        <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-[#2A3E66] dark:text-[#A8CFF1] mb-3 sm:mb-4 md:mb-5 leading-tight font-poppins">
          Mental Wellness
        ...
        <p className="text-sm xs:text-base sm:text-lg md:text-xl text-[#45A1E7] dark:text-[#B8B8B8] mb-5 sm:mb-6 md:mb-8 max-w-2xl mx-auto leading-relaxed font-montserrat px-2 sm:px-0">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-5 justify-center items-center mb-5 sm:mb-6 md:mb-8 px-2 sm:px-4 md:px-0" role="group" aria-label="Call to action buttons">
          ...
          <button 
            className="group inline-flex items-center px-5 sm:px-6 md:px-8 py-3 sm:py-3.5 md:py-4 text-[#2A3E66] dark:text-[#E8E8E8] font-semibold rounded-xl border-2 border-[#A8CFF1] dark:border-[#A8CFF1]/50 hover:border-[#45A1E7] dark:hover:border-[#45A1E7] hover:bg-[#A8CFF1]/10 dark:hover:bg-[#1A1A2E]/50 focus:outline-none focus:ring-2 focus:ring-[#45A1E7] dark:focus:ring-[#A8CFF1] focus:ring-offset-2 dark:focus:ring-offset-[#0F0F23] transition-all duration-300 font-montserrat text-sm sm:text-base md:text-lg w-full sm:w-auto justify-center min-w-[200px] sm:min-w-[220px]"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 md:gap-6 mb-5 sm:mb-6 md:mb-8 px-2 sm:px-4 md:px-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-6 max-w-4xl mx-auto px-2 sm:px-4 md:px-0">
          {LANDING_DATA.stats.map((stat, index) => (
            <div key={stat.label} className="text-center group p-3 sm:p-4 md:p-5 rounded-lg hover:bg-[#A8CFF1]/5 dark:hover:bg-[#1A1A2E]/30 transition-all duration-300">
              <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-[#2A3E66] dark:text-[#A8CFF1] mb-1 group-hover:text-[#00589F] dark:group-hover:text-[#45A1E7] transition-colors duration-300 font-poppins">
                {stat.value}
              </div>
