...
import { Heart, MessageCircle, Users, BookOpen, ArrowRight, Clock, Shield, AlertTriangle, Phone, TrendingUp, Calendar, UserCheck, BarChart3, Flag, Eye } from 'lucide-react'
...
const ModeratorDashboard = () => {
  ...
  const stats = [
    { label: 'Posts Reviewed', value: '24', icon: Eye, color: 'text-purple-600', bgColor: 'bg-purple-100' },
    { label: 'Reports Handled', value: '8', icon: Flag, color: 'text-red-600', bgColor: 'bg-red-100' },
    { label: 'Users Moderated', value: '156', icon: Users, color: 'text-blue-600', bgColor: 'bg-blue-100' },
    { label: 'Content Approved', value: '18', icon: UserCheck, color: 'text-green-600', bgColor: 'bg-green-100' }
  ]
  ...
  const recentActivities = [
    ...
    },
    {
      ...
      description: 'New post awaiting approval',
      icon: Users,
      href: '/app/community',
      color: 'bg-purple-100',
  ...
  return (
    <div className="h-[calc(100vh-64px)] w-full bg-gradient-to-br from-purple-50 via-white to-violet-50 relative overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-violet-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"></div>
      </div>
        ...
        <div className="flex-shrink-0 px-6 py-4 border-b border-gray-200/50 bg-white/80 backdrop-blur-xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="h-12 w-12 bg-gradient-to-r from-purple-500 to-violet-500 rounded-2xl flex items-center justify-center shadow-lg">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Keep the community safe and supportive for all students.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 flex overflow-hidden min-h-0">
          ...
          <div className="w-80 flex-shrink-0 bg-white/80 backdrop-blur-xl border-r border-gray-200/50 overflow-hidden">
            <div className="h-full flex flex-col">
                  ...
                  {quickActions.map((action, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <h3 className="text-xs font-semibold text-gray-900 mb-1 group-hover:text-purple-600 transition-colors duration-300">
                          {action.title}
                        </h3>
              ...
              {/* Stats */}
              <div className="flex-shrink-0 p-4 border-b border-gray-200/50">
                <h2 className="text-sm font-semibold text-gray-900 mb-3">Moderation Stats</h2>
                <div className="grid grid-cols-2 gap-3">
                          ...
                          >
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                <p className="text-sm font-semibold text-gray-900 truncate group-hover:text-purple-600 transition-colors duration-300">
                                  {activity.title}
                                </p>
                              ...
                              <ArrowRight className="h-4 w-4 text-gray-400 ml-2 group-hover:text-purple-600 transition-colors duration-300" />
                            </Link>
                          </motion.div>
                        )
                      })}
