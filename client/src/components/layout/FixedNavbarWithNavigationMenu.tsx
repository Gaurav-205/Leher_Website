...
const FixedNavbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      isScrolled
        ? 'bg-white/95 dark:bg-[#0F0F23]/95 backdrop-blur-xl border-b border-[#A8CFF1]/20 dark:border-[#A8CFF1]/30 shadow-sm'
          ...
          <div className="flex items-center flex-shrink-0">
            <Link to={isAuthenticated ? '/app' : '/'} className="flex items-center group transition-all duration-200 hover:scale-[1.02]">
              <img 
                src="/logo.png" 
                alt="Leher Logo" 
                className="h-10 w-10 object-contain transition-all duration-200 group-hover:scale-105"
                onError={(e) => {
              ...
              <span className={`ml-3 text-lg font-semibold transition-colors duration-200 group-hover:text-[#00589F] dark:group-hover:text-[#45A1E7] font-poppins ${
            ...
            <div className="hidden lg:block">
             ...
             {isAuthenticated ? (
               ...
               <div className="flex items-center space-x-3">
                 <Link
                   to="/auth/login"
                   className={`hover:text-[#00589F] dark:hover:text-[#45A1E7] font-medium text-sm transition-colors duration-200 font-montserrat ${
                     isScrolled ? 'text-[#2A3E66] dark:text-[#A8CFF1]' : 'text-[#2A3E66] dark:text-[#A8CFF1] drop-shadow-lg'
                   }`}
                 >
                   Sign In
             ...
             <button
               ...
               className={`lg:hidden p-2 rounded-lg hover:bg-[#A8CFF1]/20 dark:hover:bg-[#1A1A2E]/50 transition-colors duration-200 ${
